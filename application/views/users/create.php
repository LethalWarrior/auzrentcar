    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form class="card shadow mb-4" action="<?php echo site_url('users/store')?>" method="POST">
                <div class="card-header py-3 font-weight-bold">
                    <i class="fa fa-user-alt"></i> Create User
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col">
                            <label for="inputname">Full Name</label>
                            <input type="text" name="fullname" class="form-control" id="inputname" placeholder="Enter user's fullname">
                        </div>
                        <div class="form-group col">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="email" name="email" class="form-control" id="inputemail" placeholder="Enter user's email">
                        </div>
                        <div class="form-group col">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-dark mb-2"><i class="fa fa-plus"></i> Add User</button>
                    </div>
                </div>
            </form>
